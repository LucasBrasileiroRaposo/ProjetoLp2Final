...
public class RepositorioAtividade implements Busca {
    ...
    private RepositorioAtividade controladorAtividade;
    ...
    public int contaResultadosBusca(String termo) {
        Validadora.verificaValorNullVazio(termo,"Campo termo nao pode ser nulo ou vazio.");
        int cont = 0;
        for(String palavra: controladorAtividade.busca(termo).split(" | ")){
    ...
    public String busca(String termo, int numeroDoResultado) {
        Validadora.verificaValorNullVazio(termo,"Campo termo nao pode ser nulo ou vazio.");
        int cont = 0;
        if(termo.contains(controladorAtividade.busca(termo))){
            for(String palavra: controladorAtividade.busca(termo).split(" | ")){
                cont +=1;
