...
public class RepositorioObjetivos implements Busca {
	...
	private RepositorioObjetivos controladorObjetivos;
	...
	public RepositorioObjetivos() {
		...
		this.controladorObjetivos = new RepositorioObjetivos();
	}
	/**
	...
	public String busca(String termo) {
		...
		String msg = "";
		for(Objetivo objetivo: this.mapaObjetivos.values()){
	...
	public int contaResultadosBusca(String termo) {
		Validadora.verificaValorNullVazio(termo,"Campo termo nao pode ser nulo ou vazio.");
		int cont = 0;
		for(String palavra: controladorObjetivos.busca(termo).split(" | ")){
	...
	public String busca(String termo, int numeroDoResultado) {
		Validadora.verificaValorNullVazio(termo,"Campo termo nao pode ser nulo ou vazio.");
		int cont = 0;
		if(termo.contains(controladorObjetivos.busca(termo))){
			for(String palavra: controladorObjetivos.busca(termo).split(" | ")){
				cont +=1;
