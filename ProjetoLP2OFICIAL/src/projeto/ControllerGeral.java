...
public class ControllerGeral {
	...
	/**
	 * cadastra um problema no mapa de problemas e incrementa uma unidade no
	...
	/**
	 * cadastra um objetivo no mapa de objetivos e incrementa uma unidade no
	...
	/**
	 * Metodo que exibe uma representacao textual dos dados de um determinado
	 * problema
	 * 
	 ...
	 * @return o codigo gerado, formado pela letra A que tem em seguida o número
	 *         que indica quantos itens cadastrados vão ter .
	 */
	 ...
	 * eh removida.
	 *
	 * @param codigo String, que representa a identetificação da Atividade que o
	 *               usuario deseja remover.
	 */
	...
	/**
	 * Chamado para o cadastro do item, no caso os itens necessarios para composicao
	 * dos resultados da ativade, passando o codigo identificador da Atividade e o
	 * item que vai ser cadastrado nessa atividade.
	 *
	...
	/**
	 * Quando chamado, recebe o código da atividade que o usuário que tenha sua
	 * representacao textual exibida.
	 *
	 * @param codigo String, que identifica a atividade no mapa de atividades.
	 * @return a representacao textual dessa atividade, com informações desta e de
	 *         seus itens.
	 */
	...
	/**
	 * Quando chamado, recebe o codigo da atividade, que o sistema vai checar
	 * quantos itens ainda estao pendentes para cumprimento da atividade.
	 *
	 * @param codigo String, que identifica a atividade no mapa de atividades.
	 * @return valor em int que representa essa quantidade de itens com estado
	 *         PENDENTE.
	 */
	...
	/**
	 * Quando chamado, recebe o codigo referente a atividade que o sistema vai
	 * chechar quantos de seus itens ja estão marcados como REALIZADO.
	 *
	 * @param codigo String, que identifica a atividade no mapa de atividades.
	 * @return valor em int que representa essa quantidade de itens com estado
	 *         REALIZADO.
