...
public class ControllerPesquisadores {
    private Map<String, Pesquisadores> listaDePesquisadores;

    /**
     * Construtor responsável por inicializar o armazenamento de pesquisadores
     */
    public ControllerPesquisadores() {
    ...
    public void cadastraPesquisador(String nome, String funcao, String biografia, String email, String foto) {
        ...
        Pesquisadores P = new Pesquisadores(nome, funcao, biografia, email, foto);
