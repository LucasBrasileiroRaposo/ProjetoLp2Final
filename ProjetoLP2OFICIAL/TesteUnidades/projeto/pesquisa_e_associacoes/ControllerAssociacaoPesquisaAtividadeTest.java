...
class ControllerAssociacaoPesquisaAtividadeTest {
    ...
    void criaPesquisaAtividade(){
        this.p1 = new Pesquisa("Pesquisa de campo","Natureza","PDC");
        this.a1 = new Atividade("Atividade de Campo","MEDIO", "Aventuras Macabras");
        this.Rp1 = new RepositorioPesquisa();
        this.Ra1 = new RepositorioAtividade();
        this.cp1 = new ControllerPesquisa(Rp1);
